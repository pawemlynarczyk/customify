...
Set the scene in a forest during golden hour. Warm sunlight streams through the trees, creating strong visible sun rays and volumetric light beams.`,
    ...
    if (config.model.includes('mirage-ghibli')) {
      ...
      } else if (finalProductType === 'other' || finalProductType === 'para_krolewska' || finalProductType === 'caricature-new' || finalProductType === 'superhero' || (config.parameters?.image_input?.length === 1 && config.parameters.image_input[0] === "USER_IMAGE")) {
