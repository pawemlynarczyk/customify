  ...
  try {
    ...
    const styleConfig = {
      ...
      'superhero_boy': {
        ...
        parameters: {
          image_input: ["USER_IMAGE"],
          prompt: "Create a cinematic young superhero poster based on the provided photo. CRITICAL IDENTITY PRESERVATION - Strongly preserve the identity of the person from the reference photo. Keep the same face shape, eyes, nose, mouth, smile, skin tone, hairstyle. The superhero must clearly look like the same person from the uploaded photo. SUBJECT - Superboy flying high above a modern city skyline. Dynamic classic superhero pose, front view, one fist extended forward. Joyful, confident, energetic expression. OUTFIT - A sleek blue superhero suit with subtle red accents, large gold star emblem on the chest, flowing red cape. COMPOSITION - Vertical superhero movie poster. The person centered and dominant. Aerial city view below. LIGHTING - Golden hour, warm cinematic glow. Premium movie-poster quality.",
          aspect_ratio: "2:3",
          output_format: "jpg",
          guidance: 3.5
        }
