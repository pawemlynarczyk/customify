  ...
  try {
    ...
    const styleConfig = {
      ...
      'krolewski': {
        ...
        prompt: "Stwórz obraz w stylu jak na pierwszym obrazku, z pyskiem i głową kota z drugiego obrazka. Zachowaj kolor sierści, jej długość, kolor oczu, kształt uszu, kształt kolor nosa i wąsów kota i inne cechy identyfikujące kota z drugiego obrazka. Zwróć uwagę na nakrycie głowy, jeśli było na pierwszym obrazku aby komponowało się z głową kota.",
        apiType: "nano-banana",
