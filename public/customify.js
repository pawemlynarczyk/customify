...
Premium collectible caricature statue, highly detailed, playful but luxurious, product-photo quality render — satin/semi-matte finish, minimal glare, flattering faces, strong likeness.`,
  ...
  'karykatura-polskiego-rolnika-z-ciagnikiem-prezent-z-charakterem': {
    title: 'Personalizacja',
    promptTemplate: `Create a caricature figurine based on the provided photo.
...
Premium collectible caricature statue, highly detailed, playful but luxurious, product-photo quality render — satin/semi-matte finish, minimal glare, flattering faces, strong likeness.`,
    fields: [
      { id: 'imiona', label: 'Wpisz Imię, dedykację - tekst pojawi się na dole obrazka', type: 'text', placeholder: 'np. Jan', required: false, promptKey: 'name' },
      { id: 'rocznica', label: 'Rocznica / liczba lat - liczba pojawi się na obrazku', type: 'text', placeholder: 'np. 10, 25, 50', required: false, promptKey: 'YEARS' },
      { id: 'opis_charakteru', label: 'Opisz osobę, jej zawód, hobby - tekst nie pojawi się na obrazku ale decyduje o jego wyglądzie', type: 'text', placeholder: 'np. rolnik, traktor, pole, wieś', required: false, promptKey: 'personalization' }
    ]
  },
  'karykatura-mechanika-samochodowego-ze-zdjecia-personalizowany-prezent-dla-dziadka-taty-lub-brata': {
    title: 'Personalizacja',
    promptTemplate: `Create a caricature figurine based on the provided photo.
...
Premium collectible caricature statue, highly detailed, playful but luxurious, product-photo quality render — satin/semi-matte finish, minimal glare, flattering faces, strong likeness.`,
    fields: [
      { id: 'imiona', label: 'Wpisz Imię, dedykację - tekst pojawi się na dole obrazka', type: 'text', placeholder: 'np. Jan', required: false, promptKey: 'name' },
      { id: 'rocznica', label: 'Rocznica / liczba lat - liczba pojawi się na obrazku', type: 'text', placeholder: 'np. 10, 25, 50', required: false, promptKey: 'YEARS' },
      { id: 'opis_charakteru', label: 'Opisz osobę, jej zawód, hobby - tekst nie pojawi się na obrazku ale decyduje o jego wyglądzie', type: 'text', placeholder: 'np. mechanik, warsztat, narzędzia, samochód', required: false, promptKey: 'personalization' }
    ]
  },
  'motocyklista-karykatura-ze-zdjecia-personalizowany-prezent-dla-niego': {
    title: 'Personalizacja',
    promptTemplate: `Create a caricature figurine based on the provided photo.
...
Premium collectible caricature statue, highly detailed, playful but luxurious, product-photo quality render — satin/semi-matte finish, minimal glare, flattering faces, strong likeness.`,
    fields: [
      { id: 'imiona', label: 'Wpisz Imię, dedykację - tekst pojawi się na dole obrazka', type: 'text', placeholder: 'np. Jan', required: false, promptKey: 'name' },
      { id: 'rocznica', label: 'Rocznica / liczba lat - liczba pojawi się na obrazku', type: 'text', placeholder: 'np. 10, 25, 50', required: false, promptKey: 'YEARS' },
      { id: 'opis_charakteru', label: 'Opisz osobę, jej zawód, hobby - tekst nie pojawi się na obrazku ale decyduje o jego wyglądzie', type: 'text', placeholder: 'np. motocykl, motor, trasa, pasja do jazdy', required: false, promptKey: 'personalization' }
    ]
  },
...
Add visual elements, clothing, props and small scene details related to it.
Examples:
• firefighter → fire helmet, turnout gear, axe, fire hose, flames background
• rescue firefighter → oxygen mask, safety harness, ladder
• fire chief → red helmet, radio, command badge
...
POSE — CRITICAL: NO podium. Character in chair, FEET ON THE DESK with ANKLES CROSSED — one ankle resting on top of the other on the desktop (classic "noga za nogę" executive pose). This overrides any other pose instructions.
{YEARS_SECTION}
• Character SITTING in an executive chair behind the desk — feet ON the desk surface, ankles crossed (not parallel flat feet). Mandatory, non-negotiable.
• Hands behind head — relaxed, confident "boss" pose.
• View: full view from the side, optionally slightly from above.
• We see the whole figure, crossed ankles on desk, chair, office.
...
Premium collectible caricature statue, highly detailed, playful but luxurious, product-photo quality render — satin/semi-matte finish, minimal glare, flattering faces, strong likeness.`,
  ...
  'karykatura-dziadkow-ze-zdjecia-wesola-para-personalizowany-prezent': {
    title: 'Personalizacja',
    promptTemplate: `Create a caricature figurine based on the provided photo.
...
POSE
{YEARS_SECTION}
• Depict the person or people from the photo as cheerful, warm „weseli staruszkowie” (happy seniors): genuine smiles, cozy dignified charm, playful but respectful — never mocking age, never cruel.
...
• Premium resin-statue collectible with a SATIN / SEMI-MATTE surface — NOT mirror gloss, NOT wet plastic, NOT glassy skin.
• High-end product render, but with controlled speculars: only soft, small edge highlights; avoid blown white hotspots and "greasy" shine.
• Ultra-soft diffused studio lighting (large softbox look) — even, flattering, low-contrast on faces. No harsh top spotlight, no strong ring-light glare on foreheads, noses, and cheeks.
• Warm elegant color grading. Natural, believable skin — not orange, not yellow, not overexposed.
• Slight caricature exaggeration: minimally larger head, stylish proportions.

FACE — CRITICAL
• Strongly preserve identity from the reference: same people, clearly recognizable (face shape, eyes, nose, mouth, hair, age, ethnicity).
• Do NOT change facial structure. No "beauty surgery" reshaping.
• Friendly, natural, expressive smile when appropriate for the reference.
...
• Clothing must read as MATTE fabrics: matte wool, matte cotton, matte crepe, matte suit cloth — NOT shiny silk, NOT glossy satin, NOT latex, NOT vinyl, NOT patent leather shoes with mirror shine.
• Avoid sequins, glitter, metallic foil, rhinestones, heavy jewelry reflections unless the buyer explicitly asks for them in CUSTOMIZATION.
• If the outfit is formal (tuxedo / gown), keep it elegant but non-reflective: soft diffuse highlights only on folds, no broad bright streaks across chest, shoulders, or lapels.
• Shoes and accessories: prefer matte leather or satin-matte finish — no mirror-shine dress shoes.
• Tie / veil / jewelry: subtle, soft highlights only — no sparkling glare patches.
...
/** Karykatura ślubna młodej pary — bez domyślnej liczby, domyślny klimat ślubny. */
...
const DEFAULT_PERSONALIZATION_PER_PRODUCT = {
  ...
  'karykatura-polskiego-rolnika-z-ciagnikiem-prezent-z-charakterem': 'polski rolnik, traktor, pole, wieś',
  'karykatura-mechanika-samochodowego-ze-zdjecia-personalizowany-prezent-dla-dziadka-taty-lub-brata': 'mechanik samochodowy, warsztat, narzędzia, auto',
  'motocyklista-karykatura-ze-zdjecia-personalizowany-prezent-dla-niego': 'motocyklista, motor, trasa, pasja do jazdy',
...
class CustomifyEmbed {
  ...
  collectCustomFieldsPrompt() {
    ...
    if (config.promptTemplate) {
      ...
      config.fields.forEach(field => {
        ...
        if (field.promptKey === 'personalization') {
          ...
          if (handle && PERSONALIZATION_PREPEND_BASE_HANDLES.has(handle)) {
            const base =
              DEFAULT_PERSONALIZATION_PER_PRODUCT[handle] ||
              (handle === DIAMENTOWE_GODY_PRODUCT_HANDLE
      ...
      // {DIAMENTOWE_CUSTOMIZATION_SECTION} — zakotwiczony styl Diamentowe Gody; opis klienta = tylko akcenty (np. „złoto”)
      if (config.promptTemplate.includes('{DIAMENTOWE_CUSTOMIZATION_SECTION}')) {
  ...
  getProductTypeFromStyle(style) {
    ...
    if (currentUrl.includes('karykatura-polskiego-rolnika-z-ciagnikiem-prezent-z-charakterem')) {
      console.log('🚜 [PRODUCT-TYPE] URL = Karykatura polski rolnik z ciągnikiem → productType: caricature-new');
      return 'caricature-new';
    }
    if (currentUrl.includes('karykatura-mechanika-samochodowego-ze-zdjecia-personalizowany-prezent-dla-dziadka-taty-lub-brata')) {
      console.log('🔧 [PRODUCT-TYPE] URL = Karykatura mechanik samochodowy → productType: caricature-new');
      return 'caricature-new';
    }
    if (currentUrl.includes('motocyklista-karykatura-ze-zdjecia-personalizowany-prezent-dla-niego')) {
      console.log('🏍️ [PRODUCT-TYPE] URL = Karykatura motocyklista → productType: caricature-new');
      return 'caricature-new';
    }
    ...
    if (currentUrl.includes('fotoobraz-strazaka-ze-zdjecia-prezent-na-35-urodziny-dla-meza')) {
      console.log('🔥 [PRODUCT-TYPE] URL = Strażak → productType: caricature-new');
      return 'caricature-new';
    }
    ...
    if (currentUrl.includes('karykatura-slubna-ze-zdjecia-prezent-dla-mlodej-pary')) {
      console.log('💒 [PRODUCT-TYPE] URL = Młoda para ślub → productType: caricature-new');
      return 'caricature-new';
    }
